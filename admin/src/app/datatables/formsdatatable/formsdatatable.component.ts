...
@Component({
  selector: 'app-Formsdatatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './formsdatatable.component.html',
  styleUrl: './formsdatatable.component.css'
})
export class FormsdatatableComponent {
  events: any[] = [];
  selectedEvent: any = {};
  ...
  loadList(): void {
    this.FormsService.allList(this.limit, this.lang_code).subscribe(data => {
      this.events = data;
  ...
  editEvent(id: number): void {
    this.FormsService.getEvent(id).subscribe(data => {
  ...
  saveEvent(): void {
    ...
    this.FormsService.storeEvent(formData).subscribe(
      (event: HttpEvent<any>) => {
  ...
  modifyEvent(): void {
    ...
    this.FormsService.updateEvent(this.selectedEvent.id, formData).subscribe(
      (event: HttpEvent<any>) => {
          this.loadList(); // Refresh the list of events
