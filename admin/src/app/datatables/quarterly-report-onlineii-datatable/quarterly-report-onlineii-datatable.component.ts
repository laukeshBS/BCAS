...
import { QuarterlyReportOnlineiiService } from '../../services/quarterly-report-onlineii.service';

declare var bootstrap: any;

@Component({
  selector: 'app-quarterly-report-onlineii-datatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './quarterly-report-onlineii-datatable.component.html',
  styleUrl: './quarterly-report-onlineii-datatable.component.css'
})
export class QuarterlyReportOnlineiiDatatableComponent {
  ...
  constructor(private quarterlyReportOnlineiiService: QuarterlyReportOnlineiiService) {}
  ...
  loadList(): void {
    ...
    this.quarterlyReportOnlineiiService.allList(this.limit, this.lang_code, this.currentPage).subscribe(data => {
  ...
  viewEvent(eventId: number): void {
    this.loading = true;
    this.quarterlyReportOnlineiiService.getEvent(eventId).subscribe(event => {
