...
@Component({
  selector: 'app-catering-datatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './catering-datatable.component.html',
  styleUrl: './catering-datatable.component.css'
})
export class CateringDatatableComponent {
  ...
  constructor(private sateringService: CateringService) {}
  ...
  loadList(): void {
    ...
    this.sateringService.allList(this.limit, this.lang_code, this.currentPage).subscribe(data => {
  ...
  editEvent(id: number): void {
    this.sateringService.getEvent(id).subscribe(data => {
  ...
  saveEvent(): void {
    ...
    const requiredFields = [
      'regional_office',   // Newly added field
      'airport_name',      // Newly added field
    ...
    formData.append('regional_office', this.selectedEvent.regional_office);
