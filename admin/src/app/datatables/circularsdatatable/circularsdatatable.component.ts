...
import { CircularsService } from '../../services/circulars.service';  // Import the service
...
@Component({
  selector: 'app-Circularsdatatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './circularsdatatable.component.html',
  styleUrl: './circularsdatatable.component.css'
})
export class CircularsdatatableComponent {
  events: any[] = [];
  selectedEvent: any = {};
  ...
  loadList(): void {
    ...
    this.CircularsService.allList(this.limit, this.lang_code, this.currentPage).subscribe(data => {
  ...
  editEvent(id: number): void {
    this.CircularsService.getEvent(id).subscribe(data => {
  ...
  saveEvent(): void {
    ...
    this.CircularsService.storeEvent(formData).subscribe(
      (event: HttpEvent<any>) => {
  ...
  modifyEvent(): void {
    ...
    this.CircularsService.updateEvent(this.selectedEvent.id, formData).subscribe(
      (event: HttpEvent<any>) => {
          this.loadList(); // Refresh the list of events
  ...
  deleteEvent(id: number): void {
    if (confirm('Are you sure you want to delete this event?')) {
      this.CircularsService.deleteEvent(id).subscribe(() => {
