...
import { CommonTitleService } from '../../services/common-title.service';  // Import the service
...
@Component({
  selector: 'app-common-title-datatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './common-title-datatable.component.html',
  styleUrl: './common-title-datatable.component.css'
})
export class CommonTitleDatatableComponent {
  events: any[] = [];
  selectedEvent: any = {};
  ...
  constructor(private CommonTitleService: CommonTitleService) {}
  ...
  loadList(): void {
    ...
    this.CommonTitleService.allList(this.limit, this.lang_code, this.currentPage).subscribe(data => {
  ...
  editEvent(id: number): void {
    this.CommonTitleService.getEvent(id).subscribe(data => {
  ...
  saveEvent(): void {
    ...
    this.CommonTitleService.storeEvent(formData).subscribe(
      (event: HttpEvent<any>) => {
  ...
  modifyEvent(): void {
    ...
    this.CommonTitleService.updateEvent(this.selectedEvent.id, formData).subscribe(
      (event: HttpEvent<any>) => {
          this.loadList(); // Refresh the list of events
