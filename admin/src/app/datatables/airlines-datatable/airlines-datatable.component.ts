...
@Component({
  selector: 'app-airlines-datatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './airlines-datatable.component.html',
  styleUrl: './airlines-datatable.component.css'
})
export class AirlinesDatatableComponent {
  ...
  loadList(): void {
    ...
    this.airlinesService.allList(this.limit, this.lang_code, this.currentPage).subscribe(data => {
  ...
  editEvent(id: number): void {
    this.airlinesService.getEvent(id).subscribe(data => {
