...
import { VacanciesService } from '../../services/vacancies.service';  // Import the service
...
@Component({
  selector: 'app-Vacanciesdatatable',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './vacanciesdatatable.component.html',
  styleUrl: './vacanciesdatatable.component.css'
})
export class VacanciesdatatableComponent {
  events: any[] = [];
  selectedEvent: any = {};
  ...
  loadList(): void {
    ...
    this.VacanciesService.allList(this.limit, this.lang_code, this.currentPage).subscribe(data => {
  ...
  editEvent(id: number): void {
    this.VacanciesService.getEvent(id).subscribe(data => {
  ...
  saveEvent(): void {
    ...
    this.VacanciesService.storeEvent(formData).subscribe(
      response => {
  ...
  modifyEvent(): void {
    ...
    this.VacanciesService.updateEvent(this.selectedEvent.id, formData).subscribe(
      response => {
  ...
  deleteEvent(id: number): void {
    if (confirm('Are you sure you want to delete this event?')) {
      this.VacanciesService.deleteEvent(id).subscribe(() => {
