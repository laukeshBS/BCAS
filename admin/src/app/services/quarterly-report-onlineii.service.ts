...
export class QuarterlyReportOnlineiiService {

  private apiUrl = environment.apiBaseUrl + 'quarterly-report-onlineii-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'quarterly-report-onlineii-list-by-id';
