...
export class OpsSecurityService {

  private apiUrl = environment.apiBaseUrl + 'opssecurities-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'opssecurity-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'opssecurity-store';
  private updateApiUrl = environment.apiBaseUrl + 'opssecurity-update';
  private deleteApiUrl = environment.apiBaseUrl + 'opssecurity-delete';
