...
export class DivisionGalleryService {
  
  private apiUrl = environment.apiBaseUrl + 'division-gallery-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'division-gallery-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'division-gallery-store';
  private updateApiUrl = environment.apiBaseUrl + 'division-gallery-update';
  private deleteApiUrl = environment.apiBaseUrl + 'division-gallery-delete';
