...
export class AirportService {
  ...
  private apiUrl = environment.apiBaseUrl + 'airports-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'airport-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'airport-store';
  private updateApiUrl = environment.apiBaseUrl + 'airport-update';
  private deleteApiUrl = environment.apiBaseUrl + 'airport-delete';
