...
export class AvsecTrainingCalenderService {

  private apiUrl = environment.apiBaseUrl + 'avsec-trainings-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'avsec-training-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'avsec-training-store';
  private updateApiUrl = environment.apiBaseUrl + 'avsec-training-update';
  private deleteApiUrl = environment.apiBaseUrl + 'avsec-training-delete';
