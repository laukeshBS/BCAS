...
export class AstiService {

  private apiUrl = environment.apiBaseUrl + 'astis-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'asti-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'asti-store';
  private updateApiUrl = environment.apiBaseUrl + 'asti-update';
  private deleteApiUrl = environment.apiBaseUrl + 'asti-delete';
