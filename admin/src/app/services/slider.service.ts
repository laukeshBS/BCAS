...
export class SliderService {
  ...
  private apiUrl = environment.apiBaseUrl + 'slider-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'slider-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'slider-store';
  private updateApiUrl = environment.apiBaseUrl + 'slider-update';
  private deleteApiUrl = environment.apiBaseUrl + 'slider-delete';
