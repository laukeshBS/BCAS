...
export class CommonTitleService {
  ...
  private apiUrl = environment.apiBaseUrl + 'title-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'title-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'title-store';
  private updateApiUrl = environment.apiBaseUrl + 'title-update';
  private deleteApiUrl = environment.apiBaseUrl + 'title-delete';
