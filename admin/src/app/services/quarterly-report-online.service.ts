...
export class QuarterlyReportOnlineService {

  private apiUrl = environment.apiBaseUrl + 'quarterly-report-online-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'quarterly-report-online-list-by-id';
