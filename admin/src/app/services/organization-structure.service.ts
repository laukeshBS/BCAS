...
export class OrganizationStructureService {
  ...
  private apiUrl = environment.apiBaseUrl + 'organization-structure-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'organization-structure-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'organization-structure-store';
  private updateApiUrl = environment.apiBaseUrl + 'organization-structure-update';
  private deleteApiUrl = environment.apiBaseUrl + 'organization-structure-delete';
