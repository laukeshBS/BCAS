...
export class QuizService {
  ...
  private apiUrl = environment.apiBaseUrl + 'quizs-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'quiz-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'quiz-store';
  private updateApiUrl = environment.apiBaseUrl + 'quiz-update';
  private deleteApiUrl = environment.apiBaseUrl + 'quiz-delete';
