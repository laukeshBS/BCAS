...
export class CateringService {
  ...
  private apiUrl = environment.apiBaseUrl + 'caterings-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'catering-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'catering-store';
  private updateApiUrl = environment.apiBaseUrl + 'catering-update';
  private deleteApiUrl = environment.apiBaseUrl + 'catering-delete';
