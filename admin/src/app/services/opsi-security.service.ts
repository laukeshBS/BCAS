...
export class OpsiSecurityService {

  private apiUrl = environment.apiBaseUrl + 'opsisecurities-list';
  private getbyidapiUrl = environment.apiBaseUrl + 'opsisecurity-list-by-id';
  private storeApiUrl = environment.apiBaseUrl + 'opsisecurity-store';
  private updateApiUrl = environment.apiBaseUrl + 'opsisecurity-update';
  private deleteApiUrl = environment.apiBaseUrl + 'opsisecurity-delete';
