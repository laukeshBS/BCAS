...
use App\Models\Cms\Division\Training\DivisionCertificate;
...
class CertificateController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        $slide = DivisionCertificate::select('*') ->paginate($perPage, ['*'], 'page', $page);
        if ($slide->isNotEmpty()) {
    ...
    public function data_by_id($id)
    {
        ...
        $data = DivisionCertificate::find($validatedId);
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('document')) {
            ...
            $docUpload->move(public_path('uploads/admin/cmsfiles/division/certificates'), $docPath);
            $filePath = $docPath;
        }

        // Create a new form instance
        $data = new DivisionCertificate(); // Assuming you have a Form model
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = DivisionCertificate::find($id);
