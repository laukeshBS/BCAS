...
use App\Models\Cms\Division\Training\DivisionCertificatesCategory;
...
class CertificateCategoryController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        $slide = DivisionCertificatesCategory::select('*') ->paginate($perPage, ['*'], 'page', $page);
        if ($slide->isNotEmpty()) {
    ...
    public function data_by_id($id)
    {
        ...
        $data = DivisionCertificatesCategory::find($validatedId);
    ...
    public function store(Request $request)
    {
        ...
        $data = new DivisionCertificatesCategory(); // Assuming you have a Form model
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = DivisionCertificatesCategory::find($id);
