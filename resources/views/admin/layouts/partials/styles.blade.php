<link rel="shortcut icon" type="image/png" href="{{ asset('public/admin/assets/images/icon/favicon.ico') }}">
...
<link rel="stylesheet" href="{{ URL::asset('/public/admin/assets/summernote/summernote-bs4.css')}}">
