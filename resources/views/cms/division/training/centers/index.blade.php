    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Center List</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    @if(!empty($id))
                    <li><a href="{{ route('admin.division.training.center.index') }}"> All Center</a></li>
                    <li><span> <?php echo $parentCenter->title; ?></span></li>
                    @else
                    <li><span> Center List</span></li>
                    @endif
                </ul>
            </div>
        </div>
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            ...
            @if(!empty($id))
             <a  style="float: right;" href="{{ url('/admin/division/training/center')}}" class="btn btn-primary" >Back</a>

            @else
            <a  style="float: right;" href="{{URL::to('/admin/division/training/center/create')}}" class="btn btn-primary pull-right"> Add Center</a>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <form action="{{ url('/admin/division/training/center')}}" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
					...
					<table class="table table-striped table-bordered table-hover" >
						...
						?>
							<tr>
                              ...
                              <td><?php echo $row->position??0; ?>   <!-- <i id="{{$row->id}}" onclick="editmenu(this);"  class="fa editbut fa-edit"></i> -->
								...
								<form action="{{ route('admin.division.training.center.destroy',$row->id) }}"  method="POST"> 
                                            <td>
                                                 <a class="btn btn-primary" href="{{ route('admin.division.training.center.edit',$row->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
...
<script>
     ...
     function savedata(data) {
        ...
        var linkurl = "{{ url('/admin/update_Center_position')}}";
        
        jQuery.ajax({
            url: linkurl,
            type: "POST",
            data: {id: id,position:position ,update_Center_position:'update_Center_position'},
            cache: false,
