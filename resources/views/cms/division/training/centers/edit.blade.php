    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Center Edit</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.division.training.center.index') }}">All Centers</a></li>
                    <li><span>Edit Center </span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.division.training.center.update' , $data->id) }}" name="form1" id="form1" method="post"
                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type="radio" name="lang_code" autocomplete="off" id="lang_code" value="{{$value->lang_code}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                        ...
                                        class="input_class form-control  @error('address') is-invalid @enderror" id="txtename"  
                                        value="{{ !empty($data->address)?$data->address:old('address')}}"  />
                                        @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                        ...
                                        class="input_class form-control  @error('url') is-invalid @enderror" id="txtename"   
