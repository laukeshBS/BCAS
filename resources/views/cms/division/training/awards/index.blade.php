    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Award  List</h4>
         
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    @if(!empty($id))
                    <li><a href="{{ route('admin.division.training.award.index') }}"> All Award </a></li>
                    <li><span> <?php echo $parentaward->title; ?></span></li>
                    @else
                    <li><span> Award  List</span></li>
                    @endif
                </ul>
            </div>
        </div>
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            ...
            @if(!empty($id))
             <a  style="float: right;" href="{{ url('/admin/division/training/award')}}" class="btn btn-primary" >Back</a>

            @else
            <a  style="float: right;" href="{{URL::to('/admin/division/training/award/create')}}" class="btn btn-primary pull-right"> Add Award </a>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <form action="{{ url('/admin/division/training/award')}}" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
					...
					<table class="table table-striped table-bordered table-hover" >
						...
						?>
							<tr>
								...
								<td><?php //$cat=get_award_categories($row->category_id); echo $cat[0]->title; ?></td>
								...
								<form action="{{ route('admin.division.training.award.destroy',$row->id) }}"  method="POST"> 
                                            <td>
                                                 <a class="btn btn-primary" href="{{ route('admin.division.training.award.edit',$row->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
