    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.division.training.award.update' , $data->id) }}" name="form1" id="form1" method="post"
