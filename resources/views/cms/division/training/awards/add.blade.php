    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Award Create</h4>
...
<div class="row">
    ...
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                @endif
                <form  action="{{URL::to('/admin/division/training/award')}}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type="radio" name="lang_code" autocomplete="off" id="txtlanguage" onclick="getaward(this.value);" value="{{$value->lang_code}}"  @if(old('language') == $value->lang_code) checked @endif class="@error('lang_code') is-invalid @enderror" />{{$value->name}} &nbsp;
                                    <?php } ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <select name="category_id" class="input_class form-control" id="category_id" autocomplete="off">
                                    <option value=""> Select </option>
                                        <?php
                                        $statusArray = get_award_categories();
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                        ...
                                        class="input_class form-control  @error('position') is-invalid @enderror" id="txtename"   value="{{old('award_title')}}"  />
                                        @error('position')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xm-6">
                                <div class="">
                                    ...
                                    <a href="{{ url('/admin/division/training/award')}}" class="btn btn-primary" >Back</a>
