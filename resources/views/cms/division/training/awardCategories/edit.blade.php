...
@section('title')
Award category Edit - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Award category Edit</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.division.training.award_categories.index') }}">All award categorys</a></li>
                    <li><span>Edit award category </span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.division.training.award_categories.update' , $data->id) }}" name="form1" id="form1" method="post"
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <?php
                                    ...
                                    <input type="radio" name="lang_code" autocomplete="off" id="lang_code"
                                        onclick="getaward category(this.value,{{$data->id}})" value="{{$value->lang_code}}"
