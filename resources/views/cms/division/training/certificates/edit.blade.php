    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.division.training.certificates.update' , $data->id) }}" name="form1" id="form1" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                        ...
                                        class="input_class form-control  @error('position') is-invalid @enderror" id="txtename"   value="{{!empty($data->position)?$data->position:old('position')}}"  />
                                        @error('position')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a class="w-50" target="_blank"
                                            href="{{ URL::asset('public/uploads/admin/cmsfiles/division/training/certificates/')}}/{{$data->document}}">
                                            View PDF</a>


                                        <input type="hidden" name="oldupload" class="input_class w-50 inline-block"
                                            value="<?php echo !empty($data->document)?$data->document:''; ?>" />
