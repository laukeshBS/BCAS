        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span> <?php echo $parentGallery->title; ?></span></li>
                    @else
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            ...
            @if(!empty($id))
             <a  style="float: right;" href="{{ url('/admin/division/gallery')}}" class="btn btn-primary" >Back</a>

            @else
            <a  style="float: right;" href="{{URL::to('/admin/division/gallery/create')}}" class="btn btn-primary pull-right"> Add Gallery</a>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <form action="{{ url('/admin/division/gallery')}}" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
					...
					<table class="table table-striped table-bordered table-hover" >
						...
						?>
							<tr>
								...
								<td><?php $cat=get_gallery_categories($row->category_id);  ?></td>
								...
								<form action="{{ route('admin.division.gallery.destroy',$row->id) }}"  method="POST"> 
                                            <td>
                                                 <a class="btn btn-primary" href="{{ route('admin.division.gallery.edit',$row->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
...
<script>
     ...
     function savedata(data) {
        ...
        var linkurl = "{{ url('/admin/update_Gallery_position')}}";
        
        jQuery.ajax({
            url: linkurl,
            type: "POST",
            data: {id: id,position:position ,update_Gallery_position:'update_Gallery_position'},
            cache: false,
