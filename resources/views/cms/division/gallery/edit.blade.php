    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Gallery Edit</h4>
    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.division.gallery.update' , $data->id) }}" name="form1" id="form1" method="post"
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <input type="file" value="{{old('image')}}" name="image"
                                            class="input_class w-50 inline-block" id="image" />
                                            <?php
                                            if(!empty($data->image)){
                                            ?>
                                        <a class="w-50" target="_blank"
                                            href="{{ URL::asset('public/uploads/admin/cmsfiles/division/gallery')}}/{{$data->image}}">
                                            View Images</a>
                                            <?php }?>
                                        <input type="hidden" name="oldimage" class="input_class w-50 inline-block"
