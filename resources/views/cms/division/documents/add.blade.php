    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Document Create</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.division.document.index') }}">All Document </a></li>
...
<div class="row">
    ...
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                @endif
                <form  action="{{URL::to('/admin/division/document')}}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type="radio" name="lang_code" autocomplete="off" id="txtlanguage" onclick="getDocument(this.value);" value="{{$value->lang_code}}"  @if(old('lang_code') == $value->lang_code) checked @endif class="@error('lang_code') is-invalid @enderror" />{{$value->name}} &nbsp;
                                    <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <textarea name="description" maxlength="120" autocomplete="off" class="input_class form-control @error('description') is-invalid @enderror  summernote-simple">{{old('title')}}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                <select name="division" class="input_class form-control" id="status" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <select name="category_id" class="input_class form-control" id="category_id" autocomplete="off">
                                    <option value=""> Select </option>
                                        <?php
                                        $statusArray = get_document_categories();
                        ...
                        <div id="" >
                            <div class="row" >
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <input type="file" onchange="onlytxtuploadimg_and_pdf(this);"  name="document" class="input_class inline-block" id="txtimg_pdf" />
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xm-6">
                                <div class="">
                                    ...
                                    <a href="{{ url('/admin/division/document')}}" class="btn btn-primary" >Back</a>
