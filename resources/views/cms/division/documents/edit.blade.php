    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Document Edit</h4>
    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.division.document.update' , $data->id) }}" name="form1" id="form1" method="post"
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a class="w-50" target="_blank"
                                            href="{{ URL::asset('public/uploads/admin/cmsfiles/division/document/')}}/{{$data->document}}">
                                            View PDF</a>
