    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Gallery Categories Create</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.division.gallery_categories.index') }}">All Gallery Categoriess</a></li>
                    <li><span>Create Gallery Categories </span></li>
                </ul>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                @endif
                <form  action="{{URL::to('admin/division/gallery_categories')}}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type="radio" name="lang_code" autocomplete="off" id="txtlanguage" onclick="getGallery Categories(this.value);" value="{{$value->lang_code}}"  @if(old('language') == $value->lang_code) checked @endif class="@error('lang_code') is-invalid @enderror" />{{$value->name}} &nbsp;
                                    <?php } ?>
