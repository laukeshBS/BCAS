    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">CommonTitle List</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    @if(!empty($id))
                    <li><a href="{{ route('admin.common_title.index') }}"> All CommonTitle</a></li>
                    <li><span> <?php echo $parentCourseCategories->CoursCategories_name; ?></span></li>
                    @else
                    <li><span> CommonTitle List</span></li>
                    @endif
                </ul>
            </div>
        </div>
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            ...
            @if(!empty($id))
             <a  style="float: right;" href="{{ url('/admin/common_title')}}" class="btn btn-primary" >Back</a>

            @else
            <a  style="float: right;" href="{{URL::to('admin/common_title/create')}}" class="btn btn-primary pull-right"> Add CommonTitle</a>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <form action="{{ url('/admin/common_title')}}" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
						...
						?>
							<tr>
                                ...
                                <td><?php echo $row->slugs; ?></td>
                                 ...
                                 <!-- <i id="{{$row->id}}" onclick="editCommonTitle(this);"  class="fa editbut fa-edit"></i> -->
								...
								<td><?php  
                                    if(has_child($row->id, $row->language_id) > 0):
                                        ?>
                                        <strong><a href="{{route('admin.common_title.show', $row->id)}}"><?php echo status($row->approve_status); ?></a></strong><br/>(Click for Sub CommonTitle)
                                        <?php
                                    else:
								...
								<form action="{{ route('admin.common_title.destroy',$row->id) }}"  method="POST"> 
                                            <td>
                                                 <a class="btn btn-primary" href="{{ route('admin.common_title.edit',$row->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
